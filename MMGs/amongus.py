...
tile_path = './images/amongus/'
tiles_path = glob.glob(tile_path + '*.jpg')
# ---------------------------------------- #

# --------- CONNECT TO MIDDLEWARE --------- #
id = {
  "name" : "Among Us #AMONGUS",
  "url" : os.getenv('SERVER_URL') + ':' + os.getenv('AMONGUS_MS_PORT'),
...
if __name__ == '__main__':
  app.run(host=os.getenv('FLASK_RUN_HOST'), port=os.getenv('AMONGUS_MS_PORT'))