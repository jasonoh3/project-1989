...
id = {
  "name" : "Burgers",
  "url" : os.getenv('SERVER_URL') + ':' + os.getenv('BURGER_MS_PORT'),
...
if __name__ == '__main__':
  app.run(host=os.getenv('FLASK_RUN_HOST'), port=os.getenv('BURGER_MS_PORT'))