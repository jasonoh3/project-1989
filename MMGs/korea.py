...
id = {
  "name" : "Korea",
  "url" : os.getenv('SERVER_URL') + ':' + os.getenv('KOREA_MS_PORT'),
...
if __name__ == '__main__':
  app.run(host=os.getenv('FLASK_RUN_HOST'), port=os.getenv('KOREA_MS_PORT'))