...
id = {
  "name" : "Memes",
  "url" : os.getenv('SERVER_URL') + ':' + os.getenv('MEMES_MS_PORT'),
...
if __name__ == '__main__':
  app.run(host=os.getenv('FLASK_RUN_HOST'), port=os.getenv('MEMES_MS_PORT'))