...
id = {
  "name" : "Movie",
  "url" : os.getenv('SERVER_URL') + ':' + os.getenv('MOVIES_MS_PORT'),
...
if __name__ == '__main__':
  app.run(host=os.getenv('FLASK_RUN_HOST'), port=os.getenv('MOVIES_MS_PORT'))