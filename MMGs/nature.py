...
id = {
  "name" : "Nature",
  "url" : os.getenv('SERVER_URL') + ':' + os.getenv('NATURE_MS_PORT'),
...
if __name__ == '__main__':
  app.run(host=os.getenv('FLASK_RUN_HOST'), port=os.getenv('NATURE_MS_PORT'))