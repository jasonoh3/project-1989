...
tile_path = './images/pokemon/'
tiles_path = glob.glob(tile_path + '*.jpg')
# ---------------------------------------- #

# --------- CONNECT TO MIDDLEWARE --------- #
id = {
  "name" : "Pokemon #catchem",
  "url" : os.getenv('SERVER_URL') + ':' + os.getenv('POKEMON_MS_PORT'),
...
if __name__ == '__main__':
  app.run(host=os.getenv('FLASK_RUN_HOST'), port=os.getenv('POKEMON_MS_PORT'))